...
# Observação: Para todos os efeitos, assuma que essa loja nunca vende mais do que 40 unidades de uma mesma mercadoria para a mesma pessoa. Repare que não é necessário verificar, 
# basta assumir que isso é verdade.
...
# Saída
# Na primeira linha deve ser impresso um valor real com duas casas decimais, indicando o preço da compra sem o desconto e, na segunda linha, o preço final com o desconto aplicado, 
# também com duas casas decimais.

preco = float(input())
qtd = int(input())

valor_sem_desconto = preco * qtd
desconto = (valor_sem_desconto * 0.10) + (valor_sem_desconto * qtd * 0.01)
