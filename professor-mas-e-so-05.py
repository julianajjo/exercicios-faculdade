...
# Como é bom estar matriculado em um curso relacionado à computação! Há muitas disciplinas interessantes 
# e um mundo de descobertas! Porém, como quase tudo na vida, para ter sucesso é necessário comprometimento 
# e esforço para aprender os conteúdos que são passados pelos professores, pois exigem atenção e estudo extraclasse.
...
# receberá como entrada dois números reais, o primeiro representando a nota de trabalhos e o segundo a nota da prova regular.
# Considerando que cada uma das duas notas representa 50% da média final, seu programa exibirá uma mensagem indicando a situação 
# do aluno que poderá ser uma das três:
...
# fique maior ou igual a seis. Lembrando que, assim como a nota de trabalhos e da prova regular, a nota máxima na prova substitutiva 
...
# Saída
# Uma frase indicando a situação do aluno a quem pertencem as notas da entrada. A situação pode ser 'aprovado', 'reprovado' ou 'talvez com a sub', 
# sem os apóstrofos e completamente em minúsculo. Veja nos exemplos como a saída deve ser exibida.
